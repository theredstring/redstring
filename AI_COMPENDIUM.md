...
| **Refactor NodeCanvas, or change anything it renders (pre-1.0 refactor in progress)** | `documentation/dev-ops/nodecanvas-refactor/README.md` (current — the living plan of record; follow its agent protocol), then the phase file for your task. Supersedes the Oct-2025 `.refactor-*.md` files |
