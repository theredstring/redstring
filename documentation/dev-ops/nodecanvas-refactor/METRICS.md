...
| 2026-09-25 | P3.06a (EdgeLayer, hover in canvasUIStore) | S8 hover sweep (chambers, profile build, 3 runs) | 61 commits, 218.4 ms (P0 baseline); NodeCanvas re-rendered on every hover change | **55 commits, 95.8 ms, NodeCanvas 0**; EdgeLayer 18 | wave 6 | S6 NC 12 / S7 NC 7 unchanged (EdgeLayer renders with NodeCanvas there, as the whole edge pass did) |
| 2026-09-25 | P3.06a+ (hover-only edge renders) | S8 hover sweep (chambers, profile build, 3 runs) | 55 commits, 95.8 ms, NodeCanvas 0 | **55 commits, 40.8 ms**, NodeCanvas 0 | wave 6 | a hover-only EdgeLayer render re-renders just the connection losing hover and the one gaining it |
| 2026-09-25 | P5.02b steps 4–8 (pie machine) | S6 pie open/close; S7 select; S12 carousel (chambers, profile build, 3–5 runs) | S6 22 commits, 12 NC, 33 ms; S7 7 NC; S12 18 NC, 106 ms | **S6 20, 10 NC, 23.8 ms** (P0 62.8: halved); S7 6 NC; S12 17 NC, 81 ms | wave 6 | lifecycle effects replaced by one store write per event |
