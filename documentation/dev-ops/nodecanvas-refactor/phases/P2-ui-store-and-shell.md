...
- **P2.06a SyncDebugHost + DebugOverlay** (F-48). About 515 lines leave NodeCanvas. Status: **done** (reports/P2.06a.md): `hosts/SyncDebugHost` in CanvasShell; NodeCanvas 17,822 → 17,313.
