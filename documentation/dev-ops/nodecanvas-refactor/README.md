...
- Next: P2.09 (Panels), then P2.10, P2.11, the rest of P2.06, P2.03b, P2.03c, P2.07, P2.12, P2.13
...
| P2 | [phases/P2-ui-store-and-shell.md](phases/P2-ui-store-and-shell.md) | UI store for shared state; move Header, Panels, TypeList and modals out of NodeCanvas | **in progress**: P2.01–P2.05, P2.08, P2.06e done (wave 3) |
