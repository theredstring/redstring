...
export default defineConfig({
  ...
  server: {
    ...
    headers: {
      'Content-Security-Policy': "default-src 'self' 'unsafe-inline' 'unsafe-eval' data: blob: http://localhost:* http://127.0.0.1:* ws://localhost:* ws://127.0.0.1:*; connect-src 'self' http://localhost:* http://127.0.0.1:* ws://localhost:* ws://127.0.0.1:* https://api.github.com https://query.wikidata.org https://dbpedia.org https://*.wikipedia.org https://*.wikidata.org https://api.conceptnet.io https://*.redstring.io https://upload.wikimedia.org; img-src 'self' data: blob: http://localhost:* http://127.0.0.1:* https://*.wikipedia.org https://*.wikidata.org https://upload.wikimedia.org;"
    },
    proxy: {
