...
const SETTERS = [
  ...
  ['setLastSelectedNodePrototypes', 'lastSelectedNodePrototypes', [{ id: 'p' }], (prev) => [...prev, { id: 'q' }]],
  ['setLastSingleSelectedInstanceId', 'lastSingleSelectedInstanceId', 'inst-7', (prev) => `${prev}-next`],
